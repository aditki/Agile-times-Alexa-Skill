...
function handleSessionEndRequest(callback) {
    ...
    const speechOutput = 'Thank you for using agile times Aditya. Have a nice day!';
...
function addTimesheet(intent, session, callback) {
    ...
    if (projectSlot && typeof (projectSlot.value) !== 'undefined') {
        ...
        speechOutput = categorySlot && typeof (categorySlot.value) !== 'undefined' ? `Got it. Adding new timesheet to ${project} project, ${category} category. Aditya` : `Got it. Adding new timesheet to ${project} project.Aditya`;

        createNewTimeSheet(project, category);

    } else {
        speechOutput = "I couldn't find that project name Aditya. Please try again.";
    }
